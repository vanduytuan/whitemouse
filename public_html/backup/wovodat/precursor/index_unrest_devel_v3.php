...
<script type="text/javascript">
	...
	function loadmap(){
		...
		/* the loadmap() function is added, because this is to fix the problem(when you go to developer page, select the first valano, the second map will change randomly.)*/
		
	function volcano1_selected(){
		setupMaps(0,"1");
		volcanostatus1();
	/*delect the secondvolcano() function and add it in loadmap()*/
		}
				...
				<div id="contentrview_x">
			   	<div id="volselect">
						...
						<div style="height:25px;font-size:9px;">
							<span id="filLoading">...<img src="../gif2/loadinfo.net.gif"/></span>
						</div>
...
<?php/*         	<button id="CompareVolcanoBtn" style="font-size:9px;">View Volcano.2</button>
                	<button id="SingleVolcanoBtn" style="font-size:9px;">Hide Volcano.2</button>*/?>
								</div>
							</div>
						</div>       
                        
						<!-- second part of the panel starting from the 'Volcano 2' -->
				...
				<div id="contentlview_x" style="">
					...
					<div id="mapsite" style="display:table-row;">
						<div id="map1" style="width:407px; display:table-cell; text-align: left;">
						<div id="bigmap1" style="width:407px; height:220px;" title="BigMap1"></div>
						...
						<div id="spatial1" >
							<div id="displayeq1">
								<span><button id="reloadEqk1" style="font-size:10px; background:none;">Display Equake</button></span>
						...
						<div id="filterSS1" title="Filter Maps">
							<table width='100%' >
								<input type="hidden" id="filter1" value="0" />
									...
									<tr>
										<td>Start Date: </td>
										<td align=right><input type="textfield" id="ss_start1" /></td>
									</tr>
									<tr>
										<td>End Date: </td>
										<td align=right><input type="textfield" id="ss_end1" /></td>
									</tr>
									<tr>
										<td>Depth: </td>
							...
							<!-- ============ Temporal: TIME SERIES DATA PLOT ============================================ -->
							<div id="temporal1">
								<!-- -->
								...
								<a href="#" onclick="return false;" id="minfilG1">Hide filters</a>
					...
					<div id="map2" style="width:407px; display: table-cell;">
					<div id="bigmap2" style="width:407px; height:220px;" title="Bigmap2"></div>
					...
					<div id="spatial2">
						...
						<div id="temporal2">
							...
							<a href="#" onclick="return false;" id="minfilG2">hide filters</a>
