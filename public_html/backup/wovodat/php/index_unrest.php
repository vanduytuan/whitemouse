...
<?php
	...
	if (isset($_SESSION['login'])) {
		...
		if($uname=="ratdomopurbo" || $uname=="abaguet@ntu.edu.sg" || $uname=="cwidiwijayanti"){
?>			
		...
		<div id="wrap">
			...
			<div id="content">
				...
				<div id="contentlview"><br>
					<div style="position:relative; left:8%; width:60%;" title="Notice" id="notice">
				...
				<div id="contentrview">
					<div id="selectvolc">
						<?php if($uname=="ratdomopurbo"){?><p align="right">Login as <b><?php print $uname; ?></b></p><?php } ?>
						<table><tr>
