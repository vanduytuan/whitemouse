...
// Else, UPDATE
	...
	$field_value[3]=xml_get_ele($ms_gn_obj, "AREA");
	$field_value[4]=xml_get_ele($ms_gn_obj, "DESCRIPTION");
	$field_value[5]=xml_get_ele($ms_gn_obj, "STARTTIMEUNC");
	$field_value[6]=xml_get_ele($ms_gn_obj, "ENDTIME");
	$field_value[7]=xml_get_ele($ms_gn_obj, "ENDTIMEUNC");
	$field_value[8]=xml_get_ele($ms_gn_obj, "DIFFUTC");
	$field_value[9]=xml_get_ele($ms_gn_obj, "COMMENTS");
	$field_value[10]=$ms_gn_obj['results']['owners'][0]['id'];
	$field_value[11]=$ms_gn_obj['results']['owners'][1]['id'];
	$field_value[12]=$ms_gn_obj['results']['owners'][2]['id'];
