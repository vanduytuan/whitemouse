...
// Get owners
$owners=$er_ed_phs_vid_obj['results']['owners'];
...
if ($id==NULL) {
	...
	$field_value=array();
	$field_value[0]=$code;
	$field_value[1]=xml_get_ele($er_ed_phs_vid_obj, "LINK");
	$field_value[2]=xml_get_ele($er_ed_phs_vid_obj, "STARTTIME");
	$field_value[3]=xml_get_ele($er_ed_phs_vid_obj, "STARTTIMEUNC");
	$field_value[4]=xml_get_ele($er_ed_phs_vid_obj, "LENGTH");
	$field_value[5]=xml_get_ele($er_ed_phs_vid_obj, "DESCRIPTION");
	$field_value[6]=xml_get_ele($er_ed_phs_vid_obj, "COMMENTS");
	$field_value[7]=$er_ed_obj['id'];
	$field_value[8]=$er_ed_phs_vid_obj['results']['vd_id'];
	$field_value[9]=$er_ed_phs_vid_obj['results']['owners'][0]['id'];
	$field_value[10]=$er_ed_phs_vid_obj['results']['owners'][1]['id'];
	$field_value[11]=$er_ed_phs_vid_obj['results']['owners'][2]['id'];
	$field_value[12]=$er_ed_phs_vid_obj['results']['pubdate'];
	$field_value[13]=$cc_id_load;
	$field_value[14]=$current_time;
	$field_value[15]=$er_ed_phs_obj['id'];
...
// Else, UPDATE
	...
	$field_value=array();
	$field_value[0]=$er_ed_phs_vid_obj['results']['pubdate'];
	$field_value[1]=xml_get_ele($er_ed_phs_vid_obj, "LINK");
	$field_value[2]=xml_get_ele($er_ed_phs_vid_obj, "STARTTIME");
	$field_value[3]=xml_get_ele($er_ed_phs_vid_obj, "STARTTIMEUNC");
	$field_value[4]=xml_get_ele($er_ed_phs_vid_obj, "LENGTH");
	...
	$field_value[10]=$er_ed_phs_vid_obj['results']['owners'][1]['id'];
	$field_value[11]=$er_ed_phs_vid_obj['results']['owners'][2]['id'];
	$field_value[12]=$er_ed_phs_obj['id'];
