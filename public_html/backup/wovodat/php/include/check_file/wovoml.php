...
Step:
1. check if file extension is ".xml".. if not xml.. dispaly error and stop
2. for non developer... record upload history
3. for non developer... limit file size to 500kB .. larger than that.. store the file in "/to_be_processed" and stop
...
$gen_data=array();
$gen_data2=array();
$gen_data3=array();     // Added by Nang (for waveform)
