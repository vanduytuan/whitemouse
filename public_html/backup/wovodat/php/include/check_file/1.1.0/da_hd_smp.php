...
// ^^^ Get owners
if (!v1_get_owners($da_hd_smp_obj, $error)) {
...
// ^^^ Get instrument
v1_get_ms($da_hd_smp_obj, "INSTRUMENT", $gen_instruments);

// ^^^ Get station
v1_get_ms($da_hd_smp_obj, "STATION", $gen_stations);

// ^^^ Get publish date
v1_get_pubdate($da_hd_smp_obj);
