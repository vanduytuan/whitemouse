...
// ^^^ Get airplane
v1_get_ms($da_gd_plu_obj, "AIRPLANE", $gen_stations2);    // Nang added on 31-May-2012

// ^^^ Get satellite
v1_get_ms($da_gd_plu_obj, "SATELLITE", $gen_stations3);    // Nang added on 31-May-2012
...
array_shift($gen_stations2);  	 // Nang added on 31-May-2012
array_shift($gen_stations3);    // Nang added on 31-May-2012
