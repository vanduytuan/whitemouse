...
if ($id==NULL) {
	...
	$field_value[10]=xml_get_ele($er_for_obj, "COMMENTS");
	$field_value[11]=$ed_phs_id;
	$field_value[12]=$er_for_obj['results']['vd_id'];
	$field_value[13]=$er_for_obj['results']['owners'][0]['id'];
	$field_value[14]=$er_for_obj['results']['owners'][1]['id'];
	$field_value[15]=$er_for_obj['results']['owners'][2]['id'];
	$field_value[16]=$er_for_obj['results']['pubdate'];
