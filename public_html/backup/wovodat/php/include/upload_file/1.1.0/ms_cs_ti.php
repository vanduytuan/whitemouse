...
if ($id==NULL) {
	...
	$field_value[15]=$ms_cs_ti_obj['results']['pubdate'];
...
// Else, UPDATE
	...
	$field_value[9]=xml_get_ele($ms_cs_ti_obj, "COMMENTS");
	$field_value[10]=$ms_cs_obj['id'];
	$field_value[11]=$ms_cs_ti_obj['results']['owners'][0]['id'];
	$field_value[12]=$ms_cs_ti_obj['results']['owners'][1]['id'];
	$field_value[13]=$ms_cs_ti_obj['results']['owners'][2]['id'];
