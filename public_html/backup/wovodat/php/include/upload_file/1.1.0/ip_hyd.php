...
if ($id==NULL) {
	...
	$field_name[15]="ip_hyd_com";
	$field_name[16]="vd_id";
	$field_name[17]="cc_id";
	$field_name[18]="cc_id2";
	$field_name[19]="cc_id3";
	$field_name[20]="ip_hyd_pubdate";
	$field_name[21]="cc_id_load";
	$field_name[22]="ip_hyd_loaddate";
	...
	$field_value[15]=xml_get_ele($ip_hyd_obj, "COMMENTS");
	$field_value[16]=$ip_hyd_obj['results']['vd_id'];
	$field_value[17]=$ip_hyd_obj['results']['owners'][0]['id'];
	$field_value[18]=$ip_hyd_obj['results']['owners'][1]['id'];
	$field_value[19]=$ip_hyd_obj['results']['owners'][2]['id'];
	$field_value[20]=$ip_hyd_obj['results']['pubdate'];
