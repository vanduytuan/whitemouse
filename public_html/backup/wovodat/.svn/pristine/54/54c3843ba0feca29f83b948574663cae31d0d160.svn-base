...
//	$errors[$l_errors]['message']="&lt;".$ms_gn_name." code=\"".$ms_gn_code."\"&gt; is missing information: please specify owner";  Nang added on 09-feb-2012
...
//		$errors[$l_errors]['message']="In &lt;".$ms_gn_name." code=\"".$ms_gn_code."\"&gt;, start time (".$ms_gn_stime.") should be earlier than end time (".$ms_gn_etime.")";  Nang added on 09-feb-2012
...
//if (!v1_check_dupli_timeframe($ms_gn_name, $ms_gn_key, $ms_gn_code, $ms_gn_stime, $ms_gn_etime, $final_owners, $dupli_error)) {  Nang updated on 09-feb-2012
...
//if (!v1_check_db_cn($ms_gn_name, $ms_gn_key, $ms_gn_code, $ms_gn_stime, $ms_gn_etime, $final_owners, $check_db_error)) {  Nang updated on 09-feb-2012
