...
This is the beta version for upload_file_pu.php. As of May 2011, it is not used by the system.
			...
			<div id="add_pub">
				<table class="formtable" style="width:100%;">
					<tr>
						<th>Author(s):</th>
						<td>
							<input type="text" maxlength="255" onkeyup="search_auth(this.value)" onblur="free_search('auth_suggest')" name="auth_input" id="auth_input" />
							<div class="suggest" id="auth_suggest"></div>
						</td>
					</tr>
					<tr>
						<th>Title:</th>
						<td>
							<input type="text" maxlength="255" onkeyup="search_title(this.value)" onblur="free_search('title_suggest')" name="title_input" id="title_input" />
							<div class="suggest" id="title_suggest"></div>
						</td>
					</tr>
					<tr>
						<th>Publication year:</th>
						<td>
							<input type="text" maxlength="4" onkeydown="numbersOnly(this)" onkeyup="numbersOnly(this)" name="year_input" id="year_input" />
						</td>
					</tr>
					<tr>
						<th>Journal:</th>
						<td>
							<input type="text" maxlength="255" onkeyup="search_journ(this.value)" onblur="free_search('journ_suggest')" name="journ_input" id="journ_input" />
							<div class="suggest" id="journ_suggest"></div>
						</td>
					</tr>
					<tr>
						<th>Volume:</th>
						<td>
							<input type="text" maxlength="20" name="vol_input" id="vol_input" />
						</td>
					</tr>
					<tr>
						<th>Publisher:</th>
						<td>
							<input type="text" maxlength="50" onkeyup="search_pub(this.value)" onblur="free_search('pub_suggest')" name="pub_input" id="pub_input" />
							<div class="suggest" id="pub_suggest"></div>
						</td>
					</tr>
					<tr>
						<th>Pages:</th>
						<td>
							<input type="text" maxlength="30" name="page_input" id="page_input" />
						</td>
					</tr>
					<tr>
						<th>DOI:</th>
						<td>
							<input type="text" maxlength="20" name="doi_input" id="doi_input" />
						</td>
					</tr>
					<tr>
						<th>ISBN:</th>
						<td>
							<input type="text" maxlength="13" name="isbn_input" id="isbn_input" />
						</td>
					</tr>
					<tr>
						<th>Web:</th>
						<td>
							<input type="text" maxlength="255" name="url_input" id="url_input" />
						</td>
					</tr>
					<tr>
						<th>Observatory/laboratory email:</th>
						<td>
							<input type="text" maxlength="320" name="labadr_input" id="labadr_input" />
						</td>
					</tr>
					<tr>
						<th>Keywords:</th>
						<td>
							<input type="text" maxlength="255" name="keywords_input" id="keywords_input" />
						</td>
					</tr>
				</table>
