...
<?php
	...
	if($sta_sei_cnt>=1){//to display seismic station and create button on it
		echo "<button id='reloadSei".$divnum."' style='font-size:11px; font-family:arial; font-weight:normal; color:#000080; background:transparent; border:#f3ffed;'>".$outputs."<input type='checkbox' style='float:right;'/></button>"."<br>";
?>
...
<?php
	...
	if($sta_def_cnt>=1) {//to display deformation station and create button on it
		echo "<button id='reloadDef".$divnum."' style='font-size:11px; font-family:arial; font-weight:normal; color:#000080; background:transparent;; border:#f3ffed;'>".$outputd."<input type='checkbox' style='float:right;'/></button>"."<br>";
?>
<script type="text/javascript">
...
<?php
	...
	if($sta_hyd_cnt>=1) {
		echo "<button id='reloadHyd".$divnum."' style='font-size:11px; font-family:arial; font-weight:normal; color:#000080; background:transparent;; border:#f3ffed;'>".$outputh."<input type='checkbox' style='float:right;'/></button>"."<br>";
?>
<script type="text/javascript">
...
<?php
	...
	if($sta_the_cnt>=1) {
		echo "<button id='reloadThe".$divnum."' style='font-size:11px; font-family:arial; font-weight:normal; color:#000080; background:transparent;; border:#f3ffed;'>".$outputt."<input type='checkbox' style='float:right;'/></button>";
?>
<script type="text/javascript">
...
<?php
	...
	if($sta_gas_cnt>=1) {
		echo "<button id='reloadGas".$divnum."' style='font-size:11px; font-family:arial; font-weight:normal; color:#000080; background:transparent;; border:#f3ffed;'>".$outputg."<input type='checkbox' style='float:right;'/></button>";
?>
<script type="text/javascript">
...
<?php
	...
	if($sta_fie_cnt>=1) {
		echo "<button id='reloadFie".$divnum."' style='font-size:11px; font-family:arial; font-weight:normal; color:#000080; background:transparent;; border:#f3ffed;'>".$outputf."<input type='checkbox' style='float:right;'/></button>"."<br>";
?>
<script type="text/javascript">
