...
// Gas sta
	...
	if(!isset($outputgnum)) $outputgnum = "";
...
<?php
	...
	echo "<br><div> Stations:</div>";

?>
	<script type="text/javascript">	$("#reloadSta<?php echo $divnum;?>").show();	$("#removeSta<?php echo $divnum;?>").show(); </script>
<?php
	echo "<div style='width:100%; align:left; padding-left:5px;'>";

	if($sta_sei_cnt>=1){//to display seismic station and create button on it
		echo "<input type='checkbox' onclick='sei()' id='sei' name='sei' value='sei'/>";
		echo "<button id='reloadSei".$divnum."' style='font-size:11px; font-family:arial; font-weight:normal; color:#000080; background:transparent; border:#f3ffed;'>".$outputs."</button>"."<br/>";
...
<?php
	...
	if($sta_def_cnt>=1) {//to display deformation station and create button on it
		echo "<input type='checkbox' onclick='def()' id='def' name='def' value='def'/>";
		echo "<button id='reloadDef".$divnum."' style='font-size:11px; font-family:arial; font-weight:normal; color:#000080; background:transparent;; border:#f3ffed;'>".$outputd."</button>"."<br/>";
?>
<script type="text/javascript">
	function def()
	{
...
<?php
	...
	if($sta_hyd_cnt>=1) {
		echo "<input type='checkbox' onclick='hyd()' id='hyd' name='hyd' value='hyd'/>";
		echo "<button id='reloadHyd".$divnum."' style='font-size:11px; font-family:arial; font-weight:normal; color:#000080; background:transparent;; border:#f3ffed;'>".$outputh."</button>"."<br/>";
?>
<script type="text/javascript">
	function hyd()
	{
...
<?php
	...
	if($sta_the_cnt>=1) {
		echo "<input type='checkbox' onclick='the()' id='the' name='the' value='the'/>";
		echo "<button id='reloadThe".$divnum."' style='font-size:11px; font-family:arial; font-weight:normal; color:#000080; background:transparent;; border:#f3ffed;'>".$outputt."</button>"."<br/>";
?>
<script type="text/javascript">
	function the()
	{
...
<?php
	...
	if($sta_gas_cnt>=1) {
		echo "<input type='checkbox' onclick='gas()' id='gas' name='gas' value='gas'/>";
		echo "<button id='reloadGas".$divnum."' style='font-size:11px; font-family:arial; font-weight:normal; color:#000080; background:transparent;; border:#f3ffed;'>".$outputg."</button>"."<br/>";
?>
<script type="text/javascript">
	function gas()
	{
...
<?php
	...
	if($sta_fie_cnt>=1) {
		echo "<input type='checkbox' onclick='fie()' id='fie' name='fie' value='fie'/>";
		echo "<button id='reloadFie".$divnum."' style='font-size:11px; font-family:arial; font-weight:normal; color:#000080; background:transparent;; border:#f3ffed;'>".$outputf."</button>"."<br/>";
?>
<script type="text/javascript">
	function fie()
	{
