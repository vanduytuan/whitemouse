...
$_SESSION['upload_form'][$datatype]['gas']=$_POST['gas'];
$_SESSION['upload_form'][$datatype]['tec']=$_POST['tec'];
...
if ($code=="") {
	...
	// Must be unique
	$count_table_name="ip_pres";
	$count_field_name=array();
	$count_field_value=array();
	$count_field_name[0]="ip_pres_code";
	...
	if ($count!=0) {
		...
		$has_error=TRUE;
		$code_has_error=TRUE;
		$code_error="Buildup of magma pressure data with such code/ID already exist in database";
	}
}
...
// Check gas-induced overpressure: nothing

// Check tectonic overpressure: nothing
...
$_SESSION['upload_form'][$datatype]['gas_has_error']=$gas_has_error;
$_SESSION['upload_form'][$datatype]['tec_has_error']=$tec_has_error;
...
$_SESSION['upload_form'][$datatype]['gas_error']=$gas_error;
$_SESSION['upload_form'][$datatype]['tec_error']=$tec_error;
