...
if ($id==NULL) {
	...
	$field_name[23]="gd_plu_pubdate";
	$field_name[24]="cc_id_load";
	$field_name[25]="gd_plu_loaddate";
	...
	$field_value[17]=$gs_id;
	$field_value[18]=$gi_id;
	$field_value[19]=$da_gd_plu_plu_obj['results']['vd_id'];
	...
	$field_value[23]=$da_gd_plu_plu_obj['results']['pubdate'];
...
// Else, UPDATE
	...
	$field_value[17]=$gs_id;
	$field_value[18]=$gi_id;
	$field_value[19]=$da_gd_plu_plu_obj['results']['owners'][0]['id'];
	$field_value[20]=$da_gd_plu_plu_obj['results']['owners'][1]['id'];
	$field_value[21]=$da_gd_plu_plu_obj['results']['owners'][2]['id'];
