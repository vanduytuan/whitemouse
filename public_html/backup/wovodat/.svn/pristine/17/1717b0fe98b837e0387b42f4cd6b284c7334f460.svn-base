		...
		<div id="wrap_x">
			...
			<div id="content_x">
				...
				<div id="contentrview_x">
				   	<div id="volselect">
				   		<div><p align="right">Login as <b><?php print $uname; ?></b>&nbsp|&nbsp<a href="../populate/logout.php">Logout</a></p></div>
						<div>
				...
				<div id="contentlview_x">
					...
					<div id="mapsite">
						<div id="map1" style="width:360px; float:left; padding-left:5px;">
							...
							<div id="chronoholder1" style="background:green; width:340px; height:10px;" title="Chronology1">ccc</div>
							<div id="spatial1">
								<div id="displayeq">
						...
						<div id="map2" style="width:320px; float:left;">
							...
							<div id="chronoholder2" style="width:320px; height:80px;" title="Chronology2"></div>
							<div id="spatial2">
								<div id="displayeq2">
