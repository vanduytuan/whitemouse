...
if ($id==NULL) {
	...
	$field_name[10]="gd_sol_ori";   // Nang added on 08-May-2012
	$field_name[11]="gd_sol_com";
	$field_name[12]="gs_id";
	$field_name[13]="gi_id";
	$field_name[14]="cc_id";
	$field_name[15]="cc_id2";
	$field_name[16]="cc_id3";
	$field_name[17]="gd_sol_pubdate";
	$field_name[18]="cc_id_load";
	$field_name[19]="gd_sol_loaddate";
	...
	$field_value[10]=xml_get_ele($da_gd_sol_sol_obj, "ORGDIGITIZE");	 // Nang added on 08-May-2012
	$field_value[11]=xml_get_ele($da_gd_sol_sol_obj, "COMMENTS");
	$field_value[12]=$gs_id;
	$field_value[13]=$gi_id;
	$field_value[14]=$da_gd_sol_sol_obj['results']['owners'][0]['id'];
	$field_value[15]=$da_gd_sol_sol_obj['results']['owners'][1]['id'];
	$field_value[16]=$da_gd_sol_sol_obj['results']['owners'][2]['id'];
	$field_value[17]=$da_gd_sol_sol_obj['results']['pubdate'];
