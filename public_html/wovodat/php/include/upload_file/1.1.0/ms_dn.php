...
if ($id==NULL) {
	...
	$field_value[4]=$stime;
	$field_value[5]=xml_get_ele($ms_dn_obj, "STARTTIMEUNC");
	$field_value[6]=xml_get_ele($ms_dn_obj, "ENDTIME");
	$field_value[7]=xml_get_ele($ms_dn_obj, "ENDTIMEUNC");
...
// Else, UPDATE
	...
	$field_value=array();
	$field_value[0]=$ms_dn_obj['results']['pubdate'];
	$field_value[1]=xml_get_ele($ms_dn_obj, "NAME");
	if ($vd_ids_cnt==1) {
	...
	$field_value[3]=xml_get_ele($ms_dn_obj, "AREA");
	$field_value[4]=xml_get_ele($ms_dn_obj, "DESCRIPTION");
	$field_value[5]=xml_get_ele($ms_dn_obj, "STARTTIMEUNC");
	$field_value[6]=xml_get_ele($ms_dn_obj, "ENDTIME");
	$field_value[7]=xml_get_ele($ms_dn_obj, "ENDTIMEUNC");
	$field_value[8]=xml_get_ele($ms_dn_obj, "DIFFUTC");
	$field_value[9]=xml_get_ele($ms_dn_obj, "COMMENTS");
	$field_value[10]=$ms_dn_obj['results']['owners'][0]['id'];
	$field_value[11]=$ms_dn_obj['results']['owners'][1]['id'];
	$field_value[12]=$ms_dn_obj['results']['owners'][2]['id'];
