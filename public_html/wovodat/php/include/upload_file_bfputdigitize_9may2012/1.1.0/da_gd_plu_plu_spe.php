...
if ($id==NULL) {
	...
	$field_name[13]="gd_plu_weth";
	$field_name[14]="gd_plu_com";
	$field_name[15]="gs_id";
	$field_name[16]="gi_id";
	$field_name[17]="vd_id";
	$field_name[18]="cc_id";
	...
	$field_name[21]="gd_plu_pubdate";
	$field_name[22]="cc_id_load";
	$field_name[23]="gd_plu_loaddate";
	...
	$field_value[13]=xml_get_ele($da_gd_plu_plu_obj, "WEATHERNOTES");
	$field_value[14]=xml_get_ele($da_gd_plu_plu_obj, "COMMENTS");
	$field_value[15]=$gs_id;
	$field_value[16]=$gi_id;
	$field_value[17]=$da_gd_plu_plu_obj['results']['vd_id'];
	$field_value[18]=$da_gd_plu_plu_obj['results']['owners'][0]['id'];
	$field_value[19]=$da_gd_plu_plu_obj['results']['owners'][1]['id'];
	$field_value[20]=$da_gd_plu_plu_obj['results']['owners'][2]['id'];
	$field_value[21]=$da_gd_plu_plu_obj['results']['pubdate'];
...
// Else, UPDATE
	...
	$field_value[15]=$gs_id;
	$field_value[16]=$gi_id;
	$field_value[17]=$da_gd_plu_plu_obj['results']['owners'][0]['id'];
	$field_value[18]=$da_gd_plu_plu_obj['results']['owners'][1]['id'];
	$field_value[19]=$da_gd_plu_plu_obj['results']['owners'][2]['id'];
