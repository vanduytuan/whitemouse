	...
	$(document).ready(function(){
		...
		function showkilometer(){
			...
			if(stationdisplay =="EDMData" || stationdisplay == "MagneticFieldsData" || stationdisplay == "ElectricFieldsData" || stationdisplay == "GravityData"){			
				...
				if(stationdisplay=="PlumeData" || stationdisplay=="ThermalImage and ThermalImageData"){
		...
		$("select#stat").live('click',function() {   // click station dropdown
			...
			else if(stationdisplay == "ElectronicTiltData" || stationdisplay == "TiltVectorData" || stationdisplay == "StrainMeterData" || stationdisplay =="EDMData" || stationdisplay == "AngleData" || stationdisplay == "GPSData" || stationdisplay == "GPSVectors" || stationdisplay == "DirectlySampledGas" || stationdisplay == "SoilEffluxData" || stationdisplay == "HydrologicData" || stationdisplay == "MagneticFieldsData" || stationdisplay == "MagnetorVectorData" || stationdisplay == "ElectricFieldsData" || stationdisplay == 
			"GravityData" || stationdisplay == "GroundBasedThermalData" || stationdisplay== "ThermalImage and ThermalImageData" || stationdisplay == "PlumeData"){
