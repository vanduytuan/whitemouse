...
if(isset($plume_satellite_type)){
	...
	$data=array('...'); // creat array with value first
	...
	if(isset($data[1])){ 	
		...
		echo "<h1 style='width:300px;color: #777777;font-size:12px;font-weight: bold;font-family: lucida, sans-serif;'>No Airborne for this volcano you have chosen!<br/> Please create an airborne first!</h1>";	
	}	
