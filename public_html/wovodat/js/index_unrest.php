	...
	<div id="wrapborder">
		<div id="wrap">
			...
			<div id="content">
				...
				<!-- Right -->
				<div id="contentrview">
					<?php if($uname=="ratdomopurbo"){?>
						<div id="top" align="left">
							<!-- Aligned to the right: You are logged in as username (FName LName | Obs) | Logout -->
							<p align="right">You are logged in as <b><?php print $uname; ?></b>|<a href="logout.php">Logout</a></p>
						</div><br>
					<?php } ?>
					<div id="selectvolc">
						<table><tr>
