...
This is the reference for WOVOML 0.2, with links to an example and the schema.
...
<body>
	...
	<div id="wrap">
		...
		<p>This section contains a reference for all WOVOML elements defined in WOVOML version 0.2.</p>
		...
		<p>The complete XML schema for WOVOML can be found <a href="/doc/system/0.2/wovoml_schema.xsd">here</a>.</p>
		<p>Because WOVOML is an XML grammar and file format, tag names are case-sensitive and must appear exactly as shown here. If you're familiar with XML, you will also be interested in the <a href="/doc/system/0.2/wovoml_schema.xsd">WOVOML 0.2 Schema</a>. When you are editing WOVOML text files, you can load this Schema into any XML editor and validate your WOVOML code with it.</p>
		<p>You may also be interested in this <a href="/doc/system/0.2/wovoml_example.xml">WOVOML 0.2 Example</a> which you can edit in-co-ordination with this reference for creating your own WOVOML file.</p>

		<p><strong>Compatibility</strong></p>
		<p><span>WOVOML versions have a double numbering system: <em>majorVersion.minorVersion</em>. -- More details to be added later --</span></p>

		<h2>About this reference</h2>
		<p>This reference presents all classes (tags) defined in WOVOML version 0.2. The first tag to start with is <a href="#wovoml">&lt;wovoml&gt;</a>. This is the root element for WOVOML and it contains all the other elements.</p>
		...
		<h3>Template</h3>
<pre><strong>&lt;wovoml version=&quot;0.2&quot; xmlns=&quot;http://www.w3.org/2001/XMLSchema-instance&quot; xmlns:xsi=&quot;http://www.w3.org/2001/XMLSchema-instance&quot; xsi:schemaLocation=&quot;http://www.wovodat.org WOVOdatV1.xsd&quot;&gt;</strong>
