...
$gwater=trim($_POST['gwater']);
$ipor=trim($_POST['ipor']);
$edef=trim($_POST['edef']);
$hfrac=trim($_POST['hfrac']);
$btrem=trim($_POST['btrem']);
$abgas=trim($_POST['abgas']);
$species=trim($_POST['species']);
$chim=trim($_POST['chim']);
...
$_SESSION['upload_form'][$datatype]['gwater']=$_POST['gwater'];
$_SESSION['upload_form'][$datatype]['ipor']=$_POST['ipor'];
$_SESSION['upload_form'][$datatype]['edef']=$_POST['edef'];
$_SESSION['upload_form'][$datatype]['hfrac']=$_POST['hfrac'];
$_SESSION['upload_form'][$datatype]['btrem']=$_POST['btrem'];
$_SESSION['upload_form'][$datatype]['abgas']=$_POST['abgas'];
$_SESSION['upload_form'][$datatype]['species']=$_POST['species'];
$_SESSION['upload_form'][$datatype]['chim']=$_POST['chim'];
...
$gwater_has_error=FALSE;
$ipor_has_error=FALSE;
$edef_has_error=FALSE;
$hfrac_has_error=FALSE;
$btrem_has_error=FALSE;
$abgas_has_error=FALSE;
$species_has_error=FALSE;
$chim_has_error=FALSE;
...
if ($code=="") {
	...
	// Must be unique
	$count_table_name="ip_hyd";
	$count_field_name=array();
	$count_field_value=array();
	$count_field_name[0]="ip_hyd_code";
	...
	if ($count!=0) {
		...
		$has_error=TRUE;
		$code_has_error=TRUE;
		$code_error="Hydrothermal system interaction data with such code/ID already exist in database";
	}
}
...
// Check heated groundwater: nothing

// Check pore destabilization: nothing

// Check pore deformation: nothing

// Check hydrofracturing: nothing

// Check boiling-induced tremor: nothing

// Check soluble gases: nothing

// Check equilibrium species: nothing

// Check chimneys: nothing
...
$_SESSION['upload_form'][$datatype]['gwater_has_error']=$gwater_has_error;
$_SESSION['upload_form'][$datatype]['ipor_has_error']=$ipor_has_error;
$_SESSION['upload_form'][$datatype]['edef_has_error']=$edef_has_error;
$_SESSION['upload_form'][$datatype]['hfrac_has_error']=$hfrac_has_error;
$_SESSION['upload_form'][$datatype]['btrem_has_error']=$btrem_has_error;
$_SESSION['upload_form'][$datatype]['abgas_has_error']=$abgas_has_error;
$_SESSION['upload_form'][$datatype]['species_has_error']=$species_has_error;
$_SESSION['upload_form'][$datatype]['chim_has_error']=$chim_has_error;
...
$_SESSION['upload_form'][$datatype]['gwater_error']=$gwater_error;
$_SESSION['upload_form'][$datatype]['ipor_error']=$ipor_error;
$_SESSION['upload_form'][$datatype]['edef_error']=$edef_error;
$_SESSION['upload_form'][$datatype]['hfrac_error']=$hfrac_error;
$_SESSION['upload_form'][$datatype]['btrem_error']=$btrem_error;
$_SESSION['upload_form'][$datatype]['abgas_error']=$abgas_error;
$_SESSION['upload_form'][$datatype]['species_error']=$species_error;
$_SESSION['upload_form'][$datatype]['chim_error']=$chim_error;
