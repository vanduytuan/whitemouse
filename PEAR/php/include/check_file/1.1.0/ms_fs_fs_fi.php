...
// copy parent code ... old $code from ms_fn_fs.php
// store $table_key... "fs" from ms_fn_fs.php as $pr_table used for limit searching of duplicate stations
...
//if (!v1_check_dupli_timeframe($ms_fs_fs_fi_name, $ms_fs_fs_fi_key, $code, $ms_fs_fs_fi_stime, $ms_fs_fs_fi_etime, $final_owners, $dupli_error)) {
//if (!v1_check_dupli_timeframe2($ms_fs_fs_fi_name, $ms_fs_fs_fi_key, $code, $ms_fs_fs_fi_stime, $ms_fs_fs_fi_etime, $final_owners, $pr_code, $dupli_error)) {
...
//if (!v1_check_db_timeframe($ms_fs_fs_fi_name, $ms_fs_fs_fi_key, $code, $ms_fs_fs_fi_stime, $ms_fs_fs_fi_etime, $final_owners, $check_db_error)) {
//if (!v1_check_db_timeframe2($ms_fs_fs_fi_name, $ms_fs_fs_fi_key, $code, $ms_fs_fs_fi_stime, $ms_fs_fs_fi_etime, $final_owners, $pr_table, $pr_code, $check_db_error)) {
