...
if ($id==NULL) {
	...
	$field_value[12]=xml_get_ele($ms_gs_gs_obj, "DESCRIPTION");
	...
	$field_value[17]=$ms_gs_gs_obj['results']['pubdate'];
...
// Else, UPDATE
	...
	$field_value[11]=xml_get_ele($ms_gs_gs_obj, "DIFFUTC");
	$field_value[12]=xml_get_ele($ms_gs_gs_obj, "DESCRIPTION");
	$field_value[13]=$ms_gs_gs_obj['results']['owners'][0]['id'];
	$field_value[14]=$ms_gs_gs_obj['results']['owners'][1]['id'];
	$field_value[15]=$ms_gs_gs_obj['results']['owners'][2]['id'];
