...
if ($id==NULL) {
	...
	$field_name[15]="hi_pubdate";
	$field_name[16]="cc_id_load";
	$field_name[17]="hi_loaddate";
	...
	$field_value[10]=xml_get_ele($ms_hn_hs_hi_obj, "COMMENTS");
	$field_value[11]=$ms_hn_hs_obj['id'];
	$field_value[12]=$ms_hn_hs_hi_obj['results']['owners'][0]['id'];
	$field_value[13]=$ms_hn_hs_hi_obj['results']['owners'][1]['id'];
	$field_value[14]=$ms_hn_hs_hi_obj['results']['owners'][2]['id'];
	$field_value[15]=$ms_hn_hs_hi_obj['results']['pubdate'];
...
// Else, UPDATE
	...
	$field_value[9]=xml_get_ele($ms_hn_hs_hi_obj, "ENDTIMEUNC");
	$field_value[10]=xml_get_ele($ms_hn_hs_hi_obj, "COMMENTS");
	$field_value[11]=$ms_hn_hs_hi_obj['results']['owners'][0]['id'];
	$field_value[12]=$ms_hn_hs_hi_obj['results']['owners'][1]['id'];
	$field_value[13]=$ms_hn_hs_hi_obj['results']['owners'][2]['id'];
