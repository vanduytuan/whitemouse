...
if ($id==NULL) {
	...
	$field_name[7]="sd_evn_id";
	$field_name[8]="sd_evs_id";
	$field_name[9]="vd_id";
	$field_name[10]="cc_id";
	$field_name[11]="cc_id2";
	$field_name[12]="cc_id3";
	$field_name[13]="sd_int_pubdate";
	$field_name[14]="cc_id_load";
	$field_name[15]="sd_int_loaddate";
	...
	$field_value[7]=$sd_evn_id;
	$field_value[8]=$sd_evs_id;
	$field_value[9]=$da_sd_int_int_obj['results']['vd_id'];
	$field_value[10]=$da_sd_int_int_obj['results']['owners'][0]['id'];
	$field_value[11]=$da_sd_int_int_obj['results']['owners'][1]['id'];
	$field_value[12]=$da_sd_int_int_obj['results']['owners'][2]['id'];
	$field_value[13]=$da_sd_int_int_obj['results']['pubdate'];
