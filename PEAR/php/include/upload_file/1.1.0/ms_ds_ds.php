...
if ($id==NULL) {
	...
	$field_value[15]=$ms_ds_ds_obj['results']['owners'][0]['id'];
	$field_value[16]=$ms_ds_ds_obj['results']['owners'][1]['id'];
	$field_value[17]=$ms_ds_ds_obj['results']['owners'][2]['id'];
	$field_value[18]=$ms_ds_ds_obj['results']['pubdate'];
...
// Else, UPDATE
	...
	$field_value[12]=xml_get_ele($ms_ds_ds_obj, "REFSTATION");
	$field_value[13]=xml_get_ele($ms_ds_ds_obj, "DESCRIPTION");
	$field_value[14]=$ms_ds_ds_obj['results']['owners'][0]['id'];
	$field_value[15]=$ms_ds_ds_obj['results']['owners'][1]['id'];
	$field_value[16]=$ms_ds_ds_obj['results']['owners'][2]['id'];
