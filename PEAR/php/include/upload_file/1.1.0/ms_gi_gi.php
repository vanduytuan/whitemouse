...
if ($id==NULL) {
	...
	$field_value[10]=xml_get_ele($ms_gi_gi_obj, "COMMENTS");
	...
	$field_value[15]=$ms_gi_gi_obj['results']['pubdate'];
	$field_value[16]=$cc_id_load;
	$field_value[17]=$current_time;
	$field_value[18]=xml_get_ele($ms_gi_gi_obj, "CALIBRATION");
...
// Else, UPDATE
	...
	$field_value[9]=xml_get_ele($ms_gi_gi_obj, "ENDTIMEUNC");
	$field_value[10]=xml_get_ele($ms_gi_gi_obj, "COMMENTS");
	$field_value[11]=$ms_gi_gi_obj['results']['owners'][0]['id'];
	$field_value[12]=$ms_gi_gi_obj['results']['owners'][1]['id'];
	$field_value[13]=$ms_gi_gi_obj['results']['owners'][2]['id'];
	$field_value[14]=xml_get_ele($ms_gi_gi_obj, "CALIBRATION");
