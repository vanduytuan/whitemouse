...
if ($id==NULL) {
	...
	$field_name[14]="gd_com";
	$field_name[15]="gs_id";
	$field_name[16]="gi_id";
	$field_name[17]="cc_id";
	$field_name[18]="cc_id2";
	$field_name[19]="cc_id3";
	$field_name[20]="gd_pubdate";
	$field_name[21]="cc_id_load";
	$field_name[22]="gd_loaddate";
	...
	$field_value[14]=xml_get_ele($da_gd_smp_smp_obj, "COMMENTS");
	$field_value[15]=$gs_id;
	$field_value[16]=$gi_id;
	$field_value[17]=$da_gd_smp_smp_obj['results']['owners'][0]['id'];
	$field_value[18]=$da_gd_smp_smp_obj['results']['owners'][1]['id'];
	$field_value[19]=$da_gd_smp_smp_obj['results']['owners'][2]['id'];
	$field_value[20]=$da_gd_smp_smp_obj['results']['pubdate'];
...
// Else, UPDATE
	...
	$field_value[12]=xml_get_ele($da_gd_smp_smp_obj, "COMMENTS");
	$field_value[13]=$gs_id;
	$field_value[14]=$gi_id;
	$field_value[15]=$da_gd_smp_smp_obj['results']['owners'][0]['id'];
	$field_value[16]=$da_gd_smp_smp_obj['results']['owners'][1]['id'];
	$field_value[17]=$da_gd_smp_smp_obj['results']['owners'][2]['id'];
