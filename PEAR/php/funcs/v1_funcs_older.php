...
//	$sql="SELECT ".$table_name."_id, ".$table_name."_stime, ".$table_name."_etime FROM ".$table_name." WHERE ".$table_name."_code='".mysql_real_escape_string($code)."' AND (";
	$sql="SELECT ".$table_name."_id, ".$table_name."_stime, ".$table_name."_etime FROM ".$table_name." a,"	.$guest_table_name. " b  WHERE a."	.$table_name	."_code='".mysql_real_escape_string($code)."' AND a.".$guest_table_name."_id=b.".$guest_table_name."_id AND b.".$guest_table_name."code='".mysql_real_escape_string($guest_code)."' AND (";
...
* 			- $owners: an array of owners
******************************************************************************************************/
function v1_get_id_times2($table, $code, $owners,$parent_table,$parent_code) {
	...
	$table_name=mysql_real_escape_string($table);
	$parent_table_name=mysql_real_escape_string($parent_table);
	
	// Create SQL query
	
	$sql="SELECT "	.$table_name	."_id, "	.$table_name	."_stime, "	.$table_name	."_etime FROM "	.$table_name	.","	.$parent_table_name	. " WHERE "	.$table_name	."_code='"	.mysql_real_escape_string($code)	."' AND"	.$table_name	."\."	.$parent_table_name	."_id="	.$parent_table_name	."\."	.$parent_table_name	."_id"	." AND (";
